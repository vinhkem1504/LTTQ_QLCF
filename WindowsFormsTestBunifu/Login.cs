...
namespace WindowsFormsTestBunifu
{
    ...
    public partial class frmLogin : Form
    {
        ...
        private void bimgEye_Click(object sender, EventArgs e)
        {
            ...
            string imagePath = "\\Images\\" + (btxtPassword.UseSystemPasswordChar ? "eye-crossed.png" : "eye.png");
            btxtPassword.RightIcon.Image = Image.FromFile(Application.StartupPath + imagePath);
        }
